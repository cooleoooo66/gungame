...
function enterOtherPortal(portal) {
	...
	if(portal == 0) {z0.setEnabled(true);z1.setEnabled(true);z2.setEnabled(true);z4.setEnabled(true);z5.setEnabled(true);z6.setEnabled(true);camera.maxZ = 125;}
	if(portal == 1) {z0.setEnabled(true);z1.setEnabled(true);z4.setEnabled(true);z2.setEnabled(true);camera.maxZ = 106;}
	if(portal == 2) {z0.setEnabled(true);z1.setEnabled(true);z2.setEnabled(true);z3.setEnabled(true);z4.setEnabled(true);z5.setEnabled(true);camera.maxZ = 109;}	
	if(portal == 3) {z0.setEnabled(true);z1.setEnabled(true);z2.setEnabled(true);camera.maxZ = 107;}	
	if(portal == 4) {z3.setEnabled(true);z1.setEnabled(true);z2.setEnabled(true);z0.setEnabled(true);camera.maxZ = 95;}	
	if(portal == 5) {z4.setEnabled(true);z0.setEnabled(true);z1.setEnabled(true);camera.maxZ = 96;}	
	if(portal == 6) {z5.setEnabled(true);z0.setEnabled(true);z1.setEnabled(true);z6.setEnabled(true);z7.setEnabled(true);camera.maxZ = 109;}	
	if(portal == 7) {z6.setEnabled(true);z5.setEnabled(true);z0.setEnabled(true);z7.setEnabled(true);z8.setEnabled(true);camera.maxZ = 125;}	
	if(portal == 8) {z8.setEnabled(true);z6.setEnabled(true);z7.setEnabled(true);z9.setEnabled(true);camera.maxZ = 106;}	
	if(portal == 9) {z9.setEnabled(true);z8.setEnabled(true);z10.setEnabled(true);camera.maxZ = 93;}		
	if(portal == 10) {z10.setEnabled(true);z9.setEnabled(true);z11.setEnabled(true);z13.setEnabled(true);camera.maxZ = 112;}	
	if(portal == 11) {z10.setEnabled(true);z11.setEnabled(true);z13.setEnabled(true);z14.setEnabled(true);z15.setEnabled(true);camera.maxZ = 83;}	
	if(portal == 12) {z10.setEnabled(true);z13.setEnabled(true);z11.setEnabled(true);z12.setEnabled(true);camera.maxZ = 101;}	
	if(portal == 13) {z10.setEnabled(true);z11.setEnabled(true);z12.setEnabled(true);camera.maxZ = 101;}	
	if(portal == 14) {z13.setEnabled(true);z14.setEnabled(true);z15.setEnabled(true);z10.setEnabled(true);z11.setEnabled(true);camera.maxZ = 80;}	
	if(portal == 15) {z13.setEnabled(true);z14.setEnabled(true);z10.setEnabled(true);camera.maxZ = 75;}	
	if(portal == 16) {z13.setEnabled(true);z14.setEnabled(true);camera.maxZ = 70;}	
	if(portal == 17) {z15.setEnabled(true);z13.setEnabled(true);z16.setEnabled(true);camera.maxZ = 93;}	
	if(portal == 18) {z15.setEnabled(true);z16.setEnabled(true);z17.setEnabled(true);camera.maxZ = 69;}	
	if(portal == 19) {z16.setEnabled(true);z15.setEnabled(true);z17.setEnabled(true);camera.maxZ = 68;}	
	if(portal == 20) {z17.setEnabled(true);z16.setEnabled(true);z18.setEnabled(true);z19.setEnabled(true);camera.maxZ = 65;}	
	if(portal == 21) {z18.setEnabled(true);z17.setEnabled(true);z19.setEnabled(true);camera.maxZ = 64;}	
	if(portal == 22) {z19.setEnabled(true);z17.setEnabled(true);z18.setEnabled(true);camera.maxZ = 47;}
...
if(levelScore > bestScore) bestScore = levelScore;
	...
	if(levelScore > 9500) levelStars = 3;
...
if(localStorage.getItem('assaultzonescore') == null) {localStorage.setItem('assaultzonescore', 0);}
  bestScore = parseInt(localStorage.getItem('assaultzonescore'));	
}
// ------------------------------------------------------------------------------
function writeMemory() {
    localStorage.setItem('assaultzonescore', bestScore);	
}
